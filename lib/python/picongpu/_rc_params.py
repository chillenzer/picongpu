...
class SoftwareReference(BaseModel):
    id_: str = Field("https://doi.org/10.5281/zenodo.14513363", exclude=True)
    name: str = "PIConGPU"
    url: str | None = "https://github.com/ComputationalRadiationPhysics/picongpu"
...
def _generate_rocrate_defaults(data):
    return {
        ...
        "description": """
            ...
            From this setup an executable of PIConGPU can be compiled
            using the compile-time parameters in `include/`.
