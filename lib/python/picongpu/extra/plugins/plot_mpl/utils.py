...
def get_different_colors(n, cmap="tab20"):
    ...
    if n <= len(colors):
        ...
        try:
            ...
            fallback_cmap = "tab20"
            warn("Colormap {0} not known. Using {1} instead!".format(cmap, fallback_cmap), stacklevel=2)
...
def get_different_colormaps(n):
    ...
    for i, c in enumerate(colors):
        ...
        myCmap = mpl.colors.LinearSegmentedColormap.from_list("my_cmap_" + str(i), [myColor1, myColor2], 1200)
