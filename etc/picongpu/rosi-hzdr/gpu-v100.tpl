#!/usr/bin/env bash
# SPDX-FileCopyrightText: 2013-2024 Axel Huebl, Richard Pausch, Rene Widera, Marco Garten, Alexander Debus
...
if [ $? -eq 0 ] ; then
  # Run PIConGPU
  srun --mpi=pmix_v4 $TBG_dstPath/input/bin/picongpu --mpiDirect !TBG_author !TBG_programParams
fi
