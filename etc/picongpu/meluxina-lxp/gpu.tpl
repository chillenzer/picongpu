...
# SPDX-FileCopyrightText: 2013-2024 Axel Huebl, Richard Pausch, Rene Widera, Sergei Bastrakov, Klaus Steiniger
...
#SBATCH --mem=240G # While the nodes have 512G memory, they do not allow us to allocate more than 240G!?
