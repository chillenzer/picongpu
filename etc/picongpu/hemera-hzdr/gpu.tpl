#!/usr/bin/env bash
# SPDX-FileCopyrightText: 2013-2024 Axel Huebl, Richard Pausch, Rene Widera, Marco Garten
...
.TBG_keepOutputFileOpen=`if [ $TBG_partition == "gpu_low" ] ; then echo "SBATCH --open-mode=append"; fi`
