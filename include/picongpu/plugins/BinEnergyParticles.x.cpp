/* SPDX-FileCopyrightText: 2013-2024 Axel Huebl, Felix Schmitt, Heiko Burau, Rene Widera, Richard Pausch
...
namespace picongpu
{
    ...
    private:
        ...
        void calBinEnergyParticles(uint32_t currentStep)
        {
            ...
            float_X const minEnergy = sim.pic.conv().eV2Joule(minEnergy_keV * 1.0e3);
