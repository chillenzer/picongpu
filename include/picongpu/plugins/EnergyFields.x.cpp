 ...
 * SPDX-FileCopyrightText: 2013-2024 Rene Widera, Benjamin Worpitz
 * SPDX-FileCopyrightText: 2013-2024 Richard Pausch
    ...
    private:
        ...
        void getEnergyFields(uint32_t currentStep)
        {
            ...
            if(writeToFile)
            {
                ...
                outFile << currentStep << " " << std::scientific << globalEnergy * sim.unit.energy() << " "
                        << (globalFieldEnergy[0] * sim.unit.energy()).toString(" ", "") << " "
                        << (globalFieldEnergy[1] * sim.unit.energy()).toString(" ", "") << std::endl;
            }
        }
